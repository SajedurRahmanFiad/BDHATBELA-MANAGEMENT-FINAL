    ...
    <div className="max-w-6xl mx-auto space-y-6">
      <div className="flex items-center justify-between">
        ...
        <div className="flex gap-2">
          ...
          <button className="px-4 py-2 bg-blue-600 text-white rounded-xl font-bold hover:bg-blue-700 shadow-md">Purchase Statement</button>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
        ...
        <div className="lg:col-span-1 space-y-6">
          <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 text-center">
            <div className="w-24 h-24 rounded-full bg-blue-50 text-blue-600 flex items-center justify-center font-black text-4xl mx-auto mb-4 border-2 border-blue-100">
          ...
          <div className="bg-blue-600 p-6 rounded-2xl shadow-lg shadow-blue-200/50 text-white">
            <p className="text-blue-100 text-xs font-bold uppercase tracking-wider mb-1">Total Payable</p>
                      ...
                      >
                        ...
                        {hoveredRow === bill.id && (
                          <td className="absolute inset-y-0 right-0 flex items-center pr-6 bg-gradient-to-l from-blue-50 via-blue-50 to-transparent">
                            <div className="flex items-center gap-1 bg-white p-1 rounded-lg shadow-lg border border-blue-100 animate-in fade-in slide-in-from-right-2 duration-200" onClick={e => e.stopPropagation()}>
                              <button title="Edit" onClick={() => navigate(`/bills/edit/${bill.id}`)} className="p-2 text-gray-500 hover:text-blue-600 hover:bg-blue-50 rounded-md transition-colors">
                                {ICONS.Edit}
                              </button>
                            </div>
                          </td>
