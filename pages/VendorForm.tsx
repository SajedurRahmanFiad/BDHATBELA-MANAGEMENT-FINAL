    ...
    <div className="max-w-2xl mx-auto space-y-8 animate-in slide-in-from-bottom-4 duration-500">
      ...
      <div className="bg-white p-10 rounded-[2.5rem] border border-gray-100 shadow-xl space-y-8">
        <div className="space-y-2">
          ...
          <input 
            type="text" 
            className="w-full px-6 py-4 bg-gray-50 border-transparent focus:border-blue-500 focus:bg-white rounded-2xl font-bold transition-all outline-none"
            value={form.name}
        ...
        <div className="space-y-2">
          ...
          <textarea 
            className="w-full px-6 py-4 bg-gray-50 border-transparent focus:border-blue-500 focus:bg-white rounded-2xl font-medium h-32 transition-all outline-none"
            value={form.address}
        ...
        <button 
          onClick={handleSave}
          className="w-full py-5 bg-blue-600 text-white rounded-3xl font-black text-lg shadow-xl shadow-blue-200 hover:bg-blue-700 active:scale-95 transition-all"
        >
          Add Vendor
        </button>
      </div>
